...
def get_stock_info(stock_symbol, period='1d', interval='1m'):
    ...
    # # Get historical market data for the graph based on the selected period and interval
    # hist = stock.history(period=period, interval=interval)
    
    # Get historical market data for the graph based on the selected period
    hist = stock.history(period=period, interval=interval)
